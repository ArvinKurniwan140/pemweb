                ...
                <div class="card-body">
                    ...
                    ?>
                        <form method="post" action="update_pembelian.php">
                            <!-- Tambahkan input hidden untuk Id_Pembelian -->
                            <input type="hidden" name="Id_Pembelian" value="<?php echo $d['Id_Pembelian']; ?>">
                            
                            <div class="form-group">
                                <label>Tanggal Pembelian</label>
                                <input type="date" class="form-control input-default" name="Tgl_Pembelian" value="<?php echo $d['Tgl_Pembelian']; ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control input-default" name="Total_Harga" placeholder="Total Harga" value="<?php echo $d['Total_Harga']; ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label>Status Pembelian</label>
                                <select class="form-control" name="Status_Pembelian" required>
                                    <option value="Lunas" <?php echo ($d['Status_Pembelian'] == 'Lunas') ? 'selected' : ''; ?>>Lunas</option>
                                    <option value="Tidak" <?php echo ($d['Status_Pembelian'] == 'Tidak') ? 'selected' : ''; ?>>Tidak</option>
                                </select>
                            </div>
                            
                            <button type="submit" class="btn mb-1 btn-flat btn-primary">Simpan Perubahan</button>
                            <a href="pembelian_barang.php" class="btn mb-1 btn-flat btn-danger">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
