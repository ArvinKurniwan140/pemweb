        ...
        <div class="content-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_shift.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="Nama_Shift" placeholder="Nama Shift" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Waktu Mulai</label>
                                            <input type="time" class="form-control input-default" name="Waktu_Mulai" placeholder="Waktu Mulai" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Waktu Selessai</label>
                                            <input type="time" class="form-control input-default" name="Waktu_Selesai" placeholder="Waktu Selesai" required>
                                        </div>
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                    <a role="button" class="btn btn-info" href="edit_shift.php?id=<?php echo $d['Id_Shift']; ?>">UBAH</a>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicModal<?php echo $d['Id_Shift']; ?>">HAPUS</button>
                    </td>
                </tr>
                                    ...
                                    <div class="bootstrap-modal">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="basicModal<?php echo $d['Id_Shift']; ?>">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Hapus Data Shift</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <p class="card-text">Apakah Anda yakin ingin menghapus Shift "<?php echo $d['Nama_Shift']; ?>"?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a role ="button" class="btn btn-danger" href="hapus_shift.php?id=<?php echo $d['Id_Shift']; ?>">HAPUS</a>
