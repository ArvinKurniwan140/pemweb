...
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from kas where Id_Kas='$id'");
$d = mysqli_fetch_array($data);  // Hapus while loop, cukup fetch sekali
?>
                                    <form method="post" action="update_kas.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-default" name="Kas_Awal" placeholder="Kas Awal" required value="<?php echo $d['Kas_Awal']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Kas Akhir</label>
                                            <input type="number" class="form-control input-default" name="Kas_Akhir" placeholder="Kas Akhir" required value="<?php echo $d['Kas_Akhir']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Total_Penjualan</label>
                                            <input type="number" class="form-control input-default" name="Total_Penjualan" placeholder="Total_Penjualan" required value="<?php echo $d['Total_Penjualan']; ?>">
                                        </div>
                                        <div class="form-group">
                                ...
                                <select class="form-control" name="Id_Shift" required>
                                    ...
                                    <?php
                                    // Query untuk mengambil data supplier
                                    $supplier_query = mysqli_query($koneksi,"select * from shift");
                                    while($supplier = mysqli_fetch_array($supplier_query)) {
                                        $selected = ($supplier['Id_Shift'] == $d['Id_Shift']) ? 'selected' : '';
                                        echo "<option value='".$supplier['Id_Shift']."' ".$selected.">".$supplier['Nama_Shift']."</option>";
                                    }
                                    ?>
                                </select>
                                </div>
