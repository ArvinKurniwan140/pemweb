...
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from shift where Id_Shift='$id'");
$d = mysqli_fetch_array($data);  // Hapus while loop, cukup fetch sekali
?>
                                    <form method="post" action="update_shift.php">
                                    <input type="hidden" name="Id_Shift" value="<?php echo $d['Id_Shift']; ?>">
                                        <div class="form-group">
                                            <label>Nama Shift</label>
                                            <input type="text" class="form-control input-default" name="Nama_Shift" placeholder="Nama Shift" value="<?php echo $d['Nama_Shift']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Waktu Mulai</label>
                                            <input type="time" class="form-control input-default" name="Waktu_Mulai" placeholder="Waktu Mulai" value="<?php echo $d['Waktu_Mulai']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Waktu Selessai</label>
                                            <input type="time" class="form-control input-default" name="Waktu_Selesai" placeholder="Waktu Selesai" value="<?php echo $d['Waktu_Selesai']; ?>">
                                        </div>
