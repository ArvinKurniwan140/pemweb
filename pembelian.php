    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td class="color-primary">Rp <?php echo number_format($row['Subtotal'], 0, ',', '.'); ?></td>
                                                <td><a href="hapus_item.php?id_transaksi=<?php echo $row['Id_Transaksi']; ?>&Id_Barang=<?php echo $row['Id_Barang']; ?>" 
                                                class="text-danger">Hapus</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
            ...
            <button type="button" class="btn mb-1 btn-rounded btn-success"><a href="checkout.php">Checkout</a></button>
            </div>
            <?php } ?>
                                </div>
                            </div>
