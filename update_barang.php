    ...
    <div id="main-wrapper">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="user_kasir.php">Kasir</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <!-- Form Update Barang (update_form.php) -->
            <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Forms Update Barang</h5>
            <?php
include 'koneksi.php';
$id = $_GET['id'];
              ...
              <div class="card-body">
                <form method="POST" action="proses_edit_barang.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="Harga_Beli" name="Harga_Beli" value="<?php echo $d['Harga_Beli']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Harga Jual</label>
                        <input type="number" class="form-control" id="Harga_Jual" name="Harga_Jual" value="<?php echo $d['Harga_Jual']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Stok</label>
                        <input type="number" class="form-control" id="Stok" name="Stok" value="<?php echo $d['Stok']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="disabledSelect" class="form-label">Jenis Barang</label>
                        <select id="Jenis_Barang" name="Jenis_Barang" class="form-control">
                            <option value="Makanan" <?php if($d['Jenis_Barang']=="Makanan") echo "selected"; ?>>Makanan</option>
                            <option value="Minuman" <?php if($d['Jenis_Barang']=="Minuman") echo "selected"; ?>>Minuman</option>
                            <option value="Barang" <?php if($d['Jenis_Barang']=="Barang") echo "selected"; ?>>Barang</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Tanggal Kadaluarsa</label>
                        <input type="date" name="Tanggal_Kadaluarsa" class="form-control" id="Tanggal_Kadaluarsa" value="<?php echo $d['Tanggal_Kadaluarsa']; ?>">
                    </div>
                    <div class="mb-3">
