        ...
        <div class="content-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_pengeluaran.php">
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control input-default" name="Tanggal" placeholder="" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Jumlah</label>
                                            <input type="number" class="form-control input-default" name="Jumlah" placeholder="Jumlah" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="Kategori" placeholder="Kategori" required>
                                        </div>
                                        <div class="form-group">
                                        <label for="dropdown">Pilih Kasir:</label>
                                        <select class="form-control" name="Id_Kasir" required>
                                            ...
                                            // Loop untuk menampilkan data sebagai opsi di dropdown
                                        ...
                                        <div class="form-group">
                                        <label for="dropdown">Pilih Supplier:</label>
                                        ...
                                        <div class="form-group">
                                        <label for="dropdown">Pilih Pembelian:</label>
                                        <select class="form-control" name="Id_Pembelian" required>
                                            ...
                                            // Loop untuk menampilkan data sebagai opsi di dropdown
                                            while($row = mysqli_fetch_assoc($data)) {
                                                echo "<option value='".$row['Id_Pembelian']."'>".$row['Tgl_Pembelian']."</option>";
                                            }
                                            ?>
                                        </select>
                                        </div>
                                        <button type="submit" class="btn mb-1 btn-flat btn-primary">Tambah</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <?php 
            include 'koneksi.php';
            // Modifikasi query dengan JOIN untuk mengambil nama kasir dan shift
            $query = "SELECT pengeluaran.*, supplier.Nama_Supplier, kasir.Nama_Kasir, pembelian.Tgl_Pembelian 
                      FROM pengeluaran
                      LEFT JOIN kasir ON pengeluaran.Id_Kasir = kasir.Id_Kasir
                      LEFT JOIN pembelian ON pengeluaran.Id_Pembelian = pembelian.Id_Pembelian   
                      LEFT JOIN supplier ON pengeluaran.Id_Supplier = supplier.Id_Supplier";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                    <a role="button" class="btn btn-info" href="edit_pengeluaran.php?id=<?php echo $d['Id_Pengeluaran']; ?>">UBAH</a>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicModal<?php echo $d['Id_Pengeluaran']; ?>">HAPUS</button>
                    </td>
                </tr>
                                    ...
                                    <div class="bootstrap-modal">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="basicModal<?php echo $d['Id_Pengeluaran']; ?>">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <p class="card-text">Apakah Anda yakin ingin menghapus Pengeluaran "<?php echo $d['Tanggal']; ?>"?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a role ="button" class="btn btn-danger" href="hapus_pengeluaran.php?id=<?php echo $d['Id_Pengeluaran']; ?>">HAPUS</a>
