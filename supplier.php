        ...
        <div class="content-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_supplier.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="Nama_Supplier" placeholder="Nama Supplier" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                        ...
                                        <div class="form-group">
                                            <label>NPWP</label>
                                            <input type="number" class="form-control input-default" name="Npwp" required>
                                        </div>
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                    <a role="button" class="btn btn-info" href="edit_supplier.php?id=<?php echo $d['Id_Supplier']; ?>">UBAH</a>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicModal<?php echo $d['Id_Supplier']; ?>">HAPUS</button>
                    </td>
                </tr>
                                    ...
                                    <div class="bootstrap-modal">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="basicModal<?php echo $d['Id_Supplier']; ?>">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <p class="card-text">Apakah Anda yakin ingin menghapus Supplier "<?php echo $d['Nama_Supplier']; ?>"?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a role ="button" class="btn btn-danger" href="hapus_supplier.php?id=<?php echo $d['Id_Supplier']; ?>">HAPUS</a>
