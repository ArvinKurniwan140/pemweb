                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_member.php">
                                        <input type="hidden" name="No_Member">
                                        <input type="hidden" name="Tgl_Bergabung">
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input type="text" class="form-control input-default" name="Alamat" placeholder="Alamat" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Telepon</label>
                                            <input type="number" class="form-control input-default" name="Telepon" placeholder="Telepon" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input type="text" class="form-control input-default" name="Username" placeholder="Username" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" class="form-control input-default" name="Password" placeholder="Password" required>
                                        </div>
                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a role="button" class="btn btn-info" href="edit_member.php?id=<?php echo $d['Id_Member']; ?>">UBAH</a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicModal<?php echo $d['Id_Member']; ?>">HAPUS</button>
                                    </td>
                                </tr>

                                <div class="bootstrap-modal">
                                    <div class="modal fade" id="basicModal<?php echo $d['Id_Member']; ?>">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="card-text">Apakah Anda yakin ingin menghapus Member "<?php echo $d['Nama']; ?>"?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <a role="button" class="btn btn-danger" href="hapus_member.php?id=<?php echo $d['Id_Member']; ?>">HAPUS</a>
