...
$query_transaksi = "SELECT count(*) AS total_pengeluaran FROM pengeluaran";
$result = mysqli_query($koneksi, $query_transaksi);
$row = mysqli_fetch_assoc($result);
$total_pengeluaran = $row['total_pengeluaran'];

$query_transaksi = "SELECT count(*) AS total_pembelian FROM pembelian";
$result = mysqli_query($koneksi, $query_transaksi);
$row = mysqli_fetch_assoc($result);
$total_pembelian = $row['total_pembelian'];

$query_transaksi = "SELECT count(*) AS total_member FROM member";
$result = mysqli_query($koneksi, $query_transaksi);
$row = mysqli_fetch_assoc($result);
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo ($total_pengeluaran); ?></h2>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                <h2 class="text-white"><?php echo ($total_pembelian); ?></h2>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                <h2 class="text-white"><?php echo ($total_member); ?></h2>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                ...
                                <span class="float-right display-5 opacity-5"><i class="fa-solid fa-wallet"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
...
$query_point = "SELECT Point FROM member WHERE Id_Member = '$id_member'";
$result_point = mysqli_query($koneksi, $query_point);
$point_data = mysqli_fetch_assoc($result_point);
$total_point = $point_data['Point'];

$query_transaksi = "SELECT Count(*) as total_transaksi from transaksi";
$total = mysqli_fetch_assoc(mysqli_query($koneksi, $query_transaksi));
        ...
        <div class="header">    
            <div class="header-content clearfix">
                ...
                <div class="header-left">
                    <div class="input-group icons">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-transparent border-0 pr-2 pr-sm-3" id="basic-addon1">Welcome  <?php echo $_SESSION['Nama']; ?></span>
                        </div>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="" href="barang.php" aria-expanded="false">
                        <i class="fa-solid fa-box"></i><span class="nav-text">Barang</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="pembelian.php" aria-expanded="false">
                        <i class="fa-solid fa-cart-shopping"></i><span class="nav-text">Transaksi</span>
                        </a>
                    </li>
                </ul>
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">Keranjang</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?=$total['total_transaksi'] ?></h2>
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-shopping-cart"></i></span>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Point</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo number_format($total_point); ?></h2>
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-money"></i></span>
                            </div>
                        </div>
