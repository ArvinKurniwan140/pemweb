        ...
        <div class="content-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_rak.php">
                                        <div class="form-group">
                                            <label>Nama Rak</label>
                                            <input type="text" class="form-control input-default" name="Nama_Rak" placeholder="Nama Rak" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Kapasitas</label>
                                            <input type="number" class="form-control input-default" name="Kapasitas" placeholder="Kapasitas" required>
                                        </div>
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                    <a role="button" class="btn btn-info" href="edit_rak.php?id=<?php echo $d['Id_Rak']; ?>">UBAH</a>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#basicModal<?php echo $d['Id_Rak']; ?>">HAPUS</button>
                    </td>
                </tr>
                                    ...
                                    <div class="bootstrap-modal">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="basicModal<?php echo $d['Id_Rak']; ?>">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Hapus Data Rak</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <p class="card-text">Apakah Anda yakin ingin menghapus Rak "<?php echo $d['Nama_Rak']; ?>"?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                    <a role ="button" class="btn btn-danger" href="hapus_rak.php?id=<?php echo $d['Id_Rak']; ?>">HAPUS</a>
