...
?>
                                    ...
                                    <input type="hidden" name="Id_Supplier" value="<?php echo $d['Id_Supplier']; ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" name="Nama_Supplier" placeholder="Nama Supplier" value="<?php echo $d['Nama_Supplier']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input type="text" class="form-control input-default" name="Alamat" placeholder="Alamat" value="<?php echo $d['Alamat']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Telepon</label>
                                            <input type="number" class="form-control input-default" name="Telepon" placeholder="Telepon" value="<?php echo $d['Telepon']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control input-default" name="Email" placeholder="Email" value="<?php echo $d['Email']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>NPWP</label>
                                            <input type="number" class="form-control input-default" name="Npwp" value="<?php echo $d['Npwp']; ?>">
                                        </div>
