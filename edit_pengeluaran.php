...
$d = mysqli_fetch_array($data);  // Hapus while loop, cukup fetch sekali
?>
                                    <form method="post" action="update_pengeluaran.php">
                                    <input type="hidden" name="Id_Pengeluaran" value="<?php echo $d['Id_Pengeluaran']; ?>">
                                    <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" class="form-control input-default" name="Tanggal" placeholder="" required value="<?php echo $d['Tanggal']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Jumlah</label>
                                            <input type="number" class="form-control input-default" name="Jumlah" placeholder="Jumlah" required value="<?php echo $d['Jumlah']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <input type="text" class="form-control input-default" name="Keterangan" placeholder="Keterangan" required value="<?php echo $d['Keterangan']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Kategori</label>
                                            <input type="text" class="form-control input-default" name="Kategori" placeholder="Kategori" required value="<?php echo $d['Kategori']; ?>">
                                        </div>
                                        <div class="form-group">
                                ...
                                <select class="form-control" name="Id_Kasir" required>
                                    ...
                                    $supplier_query = mysqli_query($koneksi,"select * from kasir");
                                    while($supplier = mysqli_fetch_array($supplier_query)) {
                                        $selected = ($supplier['Id_Kasir'] == $d['Id_Kasir']) ? 'selected' : '';
                                        echo "<option value='".$supplier['Id_Kasir']."' ".$selected.">".$supplier['Nama_Kasir']."</option>";
                                    }
                                    ?>
                                </select>
                                </div>
                                ...
                                <select class="form-control" name="Id_Supplier" required>
                                    ...
                                    while($supplier = mysqli_fetch_array($supplier_query)) {
                                        $selected = ($supplier['Id_Supplier'] == $d['Id_Supplier']) ? 'selected' : '';
                                ...
                                <select class="form-control" name="Id_Pembelian" required>
                                    ...
                                    <?php
                                    // Query untuk mengambil data supplier
                                    $supplier_query = mysqli_query($koneksi,"select * from pembelian");
                                    while($supplier = mysqli_fetch_array($supplier_query)) {
                                        $selected = ($supplier['Id_Pembelian'] == $d['Id_Pembelian']) ? 'selected' : '';
                                        echo "<option value='".$supplier['Id_Pembelian']."' ".$selected.">".$supplier['Tgl_Pembelian']."</option>";
                                    }
                                    ?>
                                </select>
                                </div>
                                        <button type="submit" class="btn mb-1 btn-flat btn-primary">Edit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
