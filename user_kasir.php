                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="tambah_usr_ksr.php">
                                        <input type="hidden" name="Tgl_Mulai_Kerja">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" class="form-control input-default" name="Nama_Kasir" placeholder="Nama" required>
                                        </div>
                                        <div class="form-group">
