...
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from rak where Id_Rak='$id'");
$d = mysqli_fetch_array($data);  // Hapus while loop, cukup fetch sekali
?>
                                    <form method="post" action="update_rak.php">
                                    <input type="hidden" name="Id_Rak" value="<?php echo $d['Id_Rak']; ?>">
                                        <div class="form-group">
                                            <label>Nama Rak</label>
                                            <input type="text" class="form-control input-default" name="Nama_Rak" placeholder="Nama Rak" value="<?php echo $d['Nama_Rak']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Kapasitas</label>
                                            <input type="number" class="form-control input-default" name="Kapasitas" placeholder="Kapasitas" value="<?php echo $d['Kapasitas']; ?>">
                                        </div>
